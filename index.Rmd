...
This R session will explain the fundamentals of some of these problems and the issues involved with projections, visualizations, analyses and measurements and provide techniques for using map projections in polar regions. We will also introduce some some emerging tools that should make life easier and ease the process of working with map projections. 

Installation instructions: https://mdsumner.github.io/polar-mapping-oghub/getting-set-up.html#getting-set-up

Datasets in use: 

map coastline from maps package, wrld_simpl from maptools package, example sea surface temperature data (OISST 2019-08-06), example sea ice concentration data (NSIDC 2019-08-06), regional polar polygons as used in Trebilco et al. (2019)
